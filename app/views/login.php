<?php 
// Detectamos si viene un error por la URL
...
<head>
    <meta charset="UTF-8">
    <title>GYM UPA | Acceso Socios</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .footer-links a span { color: var(--accent-blue); font-weight: 800; }
    </style>
</head>
<body>
    ...
    <?php if(isset($_GET['error']) && $_GET['error'] == '1'): ?>
        <div class="alert-badge">⚠️ ACCESO DENEGADO: EL USUARIO NO EXISTE O LOS DATOS SON INCORRECTOS</div>
    <?php endif; ?>
    ...
    <div class="glass-card">
        ...
        <form action="../../api/login_proceso.php" method="POST">
            <div class="form-group">
                <label>CORREO</label>
                <input type="email" name="correo" placeholder="tu@upatlacomulco.edu.mx" required>
            </div>
        ...
        <div class="footer-links">
            ...
            <a href="registro.php">¿NO TIENES CUENTA? <span>REGÍSTRATE</span></a>
        </div>
    </div>
    ...
    <script type="module">
        ...
        const fragment = `
            ...
            void main() {
                ...
                float f = fbm(p + 4.0 * r);
                vec3 col = mix(vec3(0.0), vec3(0.0, 0.15, 0.4), clamp((f*f)*4.0, 0.0, 1.0));
                col += 0.5 * pow(f, 3.0) * vec3(0.1, 0.6, 1.0);
                col *= 1.4;
